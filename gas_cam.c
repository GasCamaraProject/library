...
void randMat(int matrix_temp[ ][SNAPSHOT_WIDTH]){
    int i,new_temp,height_pos,width_pos,num_iterations=0.1*SNAPSHOT_WIDTH*SNAPSHOT_HEIGHT;
...
void covert_to_rgb(int* rgb_matrix[SNAPSHOT_HEIGHT][SNAPSHOT_WIDTH],int matrix[SNAPSHOT_HEIGHT][SNAPSHOT_WIDTH]){
...
void* capture(void* stg){
    ...
    Node*n;
    int i=0, matrix[SNAPSHOT_HEIGHT][SNAPSHOT_WIDTH]={27};
    while(1){
        randMat(matrix);
